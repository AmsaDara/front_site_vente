...
import { Plugins, VideoSources } from '@cloudinary/html';
/**
 * @memberOf AngularSDK
 * @type {Component}
...
export declare class CloudinaryVideoComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<CloudinaryVideoComponent, "advanced-video", never, { "cldVid": "cldVid"; "sources": "sources"; "plugins": "plugins"; "poster": "poster"; "innerRef": "innerRef"; }, { "play": "play"; "loadstart": "loadstart"; "playing": "playing"; "error": "error"; "ended": "ended"; }, never, never>;
}
